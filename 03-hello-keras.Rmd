...
The final layer uses a different transformation than the rest of them.
...
The model we've built is a small covnet. It is sa stack of alternated 2d layers with relu activation
