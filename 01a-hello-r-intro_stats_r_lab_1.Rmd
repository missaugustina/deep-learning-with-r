...
ggplot(data = arbuthnot, aes(year)) + 
  geom_line(aes(y = boys/total, color = "boys")) + 
  geom_line(aes(y = girls/total, color = "girls"))
```
...
# type your modification then uncomment and knit
# range(???)
```
...
# type your answer then uncomment and knit
...
# calculate boy-to-girl ratio, store in "prop_boy_girl" in the present dataset
...
# head(arrange(present, desc(???)),1)$year
```
